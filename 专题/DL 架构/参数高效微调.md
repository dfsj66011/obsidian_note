...
- [Overview](https://aman.ai/primers/ai/parameter-efficient-fine-tuning/#overview)
- [Parameter-Efficient Fine-Tuning (PEFT)](https://aman.ai/primers/ai/parameter-efficient-fine-tuning/#parameter-efficient-fine-tuning-peft)
- [Advantages](https://aman.ai/primers/ai/parameter-efficient-fine-tuning/#advantages)
    - [Practical Use-case](https://aman.ai/primers/ai/parameter-efficient-fine-tuning/#practical-use-case)
...
![](https://aman.ai/primers/ai/assets/parameter-efficient-fine-tuning/peftOverview.png)
...
![](https://aman.ai/primers/ai/assets/parameter-efficient-fine-tuning/PromptTuning.jpg)
