...
- [Terminology](https://aman.ai/primers/ai/speech-processing/#terminology)
    - [Phoneme](https://aman.ai/primers/ai/speech-processing/#phoneme)
    - [Phone](https://aman.ai/primers/ai/speech-processing/#phone)
    - [Why Do We Need Phonemes and Phones?](https://aman.ai/primers/ai/speech-processing/#why-do-we-need-phonemes-and-phones)
    - [Allophones](https://aman.ai/primers/ai/speech-processing/#allophones)
        - [Environments of Phonemes](https://aman.ai/primers/ai/speech-processing/#environments-of-phonemes)
    - [Graphemes](https://aman.ai/primers/ai/speech-processing/#graphemes)
    - [Mono vs. Stereo Sound](https://aman.ai/primers/ai/speech-processing/#mono-vs-stereo-sound)
    - [Key Takeaways](https://aman.ai/primers/ai/speech-processing/#key-takeaways)
- [Feature Representations](https://aman.ai/primers/ai/speech-processing/#feature-representations)
    - [Oscillogram](https://aman.ai/primers/ai/speech-processing/#oscillogram)
    - [Spectrum](https://aman.ai/primers/ai/speech-processing/#spectrum)
    - [Spectrogram](https://aman.ai/primers/ai/speech-processing/#spectrogram)
    - [Why Spectrograms?](https://aman.ai/primers/ai/speech-processing/#why-spectrograms)
- [How are Tokenizers Used for Pre-processing Speech Input?](https://aman.ai/primers/ai/speech-processing/#how-are-tokenizers-used-for-pre-processing-speech-input)
- [What are “tokens” When Embedding an Audio Sample Using an Encoder? How are They Different Compared to Word/sub-word Tokens in NLP?](https://aman.ai/primers/ai/speech-processing/#what-are-tokens-when-embedding-an-audio-sample-using-an-encoder-how-are-they-different-compared-to-wordsub-word-tokens-in-nlp)
    - [Mel-Filterbanks and MFCCs](https://aman.ai/primers/ai/speech-processing/#mel-filterbanks-and-mfccs)
    - [Example Spectrogram and Oscillogram](https://aman.ai/primers/ai/speech-processing/#example-spectrogram-and-oscillogram)
    - [Perceptual Linear Prediction (PLP)](https://aman.ai/primers/ai/speech-processing/#perceptual-linear-prediction-plp)
    - [Prosodic Features](https://aman.ai/primers/ai/speech-processing/#prosodic-features)
    - [Idiolectal Features](https://aman.ai/primers/ai/speech-processing/#idiolectal-features)
- [Speech Processing Tasks](https://aman.ai/primers/ai/speech-processing/#speech-processing-tasks)
    - [Architectural Overview](https://aman.ai/primers/ai/speech-processing/#architectural-overview)
    - [Fundamental Speech Tasks](https://aman.ai/primers/ai/speech-processing/#fundamental-speech-tasks)
    - [Hierarchy of Phones, Words, and Sentences](https://aman.ai/primers/ai/speech-processing/#hierarchy-of-phones-words-and-sentences)
    - [Automatic Speech Recognition](https://aman.ai/primers/ai/speech-processing/#automatic-speech-recognition)
        - [What is Automatic Speech Recognition?](https://aman.ai/primers/ai/speech-processing/#what-is-automatic-speech-recognition)
        - [Framework of an ASR System](https://aman.ai/primers/ai/speech-processing/#framework-of-an-asr-system)
        - [Acoustic Model (Encoder)](https://aman.ai/primers/ai/speech-processing/#acoustic-model-encoder)
        - [Encoder-Decoder Architectures: Past vs. Present](https://aman.ai/primers/ai/speech-processing/#encoder-decoder-architectures-past-vs-present)
        - [Putting It All Together](https://aman.ai/primers/ai/speech-processing/#putting-it-all-together)
    - [Keyword Spotting / Wakeword Detection](https://aman.ai/primers/ai/speech-processing/#keyword-spotting--wakeword-detection)
    - [Measuring Performance](https://aman.ai/primers/ai/speech-processing/#measuring-performance)
        - [Precision](https://aman.ai/primers/ai/speech-processing/#precision)
        - [Recall](https://aman.ai/primers/ai/speech-processing/#recall)
        - [Precision-Recall (PR) Curves](https://aman.ai/primers/ai/speech-processing/#precision-recall-pr-curves)
        - [F1-score](https://aman.ai/primers/ai/speech-processing/#f1-score)
        - [Detection Error Trade-off (DET) Curves](https://aman.ai/primers/ai/speech-processing/#detection-error-trade-off-det-curves)
        - [Online Learning with Live Data to Improve Robustness](https://aman.ai/primers/ai/speech-processing/#online-learning-with-live-data-to-improve-robustness)
    - [Handling Dynamic Language Switching and Code Switching](https://aman.ai/primers/ai/speech-processing/#handling-dynamic-language-switching-and-code-switching)
    - [Speaker Recognition](https://aman.ai/primers/ai/speech-processing/#speaker-recognition)
- [Data Augmentation](https://aman.ai/primers/ai/speech-processing/#data-augmentation)
    - [Time Domain](https://aman.ai/primers/ai/speech-processing/#time-domain)
        - [Gain](https://aman.ai/primers/ai/speech-processing/#gain)
        - [Types of Noise](https://aman.ai/primers/ai/speech-processing/#types-of-noise)
            - [Reverberation Noise / Room Impulse Response (RIR)](https://aman.ai/primers/ai/speech-processing/#reverberation-noise--room-impulse-response-rir)
            - [Babble Noise](https://aman.ai/primers/ai/speech-processing/#babble-noise)
        - [Speed and Pitch](https://aman.ai/primers/ai/speech-processing/#speed-and-pitch)
        - [Codec Augmentation](https://aman.ai/primers/ai/speech-processing/#codec-augmentation)
        - [Mixup](https://aman.ai/primers/ai/speech-processing/#mixup)
        - [Dynamic Range Compression](https://aman.ai/primers/ai/speech-processing/#dynamic-range-compression)
    - [Frequency Domain](https://aman.ai/primers/ai/speech-processing/#frequency-domain)
        - [SpecAugment](https://aman.ai/primers/ai/speech-processing/#specaugment)
- [Evaluation Metrics](https://aman.ai/primers/ai/speech-processing/#evaluation-metrics)
    - [Precision and Recall](https://aman.ai/primers/ai/speech-processing/#precision-and-recall)
        - [Historical Background](https://aman.ai/primers/ai/speech-processing/#historical-background)
        - [Examples](https://aman.ai/primers/ai/speech-processing/#examples)
        - [Applications](https://aman.ai/primers/ai/speech-processing/#applications)
        - [Formulae](https://aman.ai/primers/ai/speech-processing/#formulae)
        - [Precision/Recall Tradeoff](https://aman.ai/primers/ai/speech-processing/#precisionrecall-tradeoff)
    - [Receiver Operating Characteristic (ROC) Curve](https://aman.ai/primers/ai/speech-processing/#receiver-operating-characteristic-roc-curve)
    - [Detection Error Tradeoff (DET) Curve](https://aman.ai/primers/ai/speech-processing/#detection-error-tradeoff-det-curve)
        - [Comparing ROC and DET Curves](https://aman.ai/primers/ai/speech-processing/#comparing-roc-and-det-curves)
        - [Area Under the ROC Curve (AUC)](https://aman.ai/primers/ai/speech-processing/#area-under-the-roc-curve-auc)
    - [Precision-Recall Curve](https://aman.ai/primers/ai/speech-processing/#precision-recall-curve)
        - [Area Under the PR Curve (AUC)](https://aman.ai/primers/ai/speech-processing/#area-under-the-pr-curve-auc)
    - [Key Takeaways: Precision, Recall and ROC/PR Curves](https://aman.ai/primers/ai/speech-processing/#key-takeaways-precision-recall-and-rocpr-curves)
    - [Speech Recognition](https://aman.ai/primers/ai/speech-processing/#speech-recognition)
    - [Speech-to-Speech Machine Translation](https://aman.ai/primers/ai/speech-processing/#speech-to-speech-machine-translation)
    - [Manual Evaluation by Humans for Fluency, Grammar, Comparative Ranking, Etc.](https://aman.ai/primers/ai/speech-processing/#manual-evaluation-by-humans-for-fluency-grammar-comparative-ranking-etc)
- [🤗 Open ASR Leaderboard](https://aman.ai/primers/ai/speech-processing/#-open-asr-leaderboard)
- [Popular Models](https://aman.ai/primers/ai/speech-processing/#popular-models)
    - [Distil-Whisper](https://aman.ai/primers/ai/speech-processing/#distil-whisper)
    - [Parakeet](https://aman.ai/primers/ai/speech-processing/#parakeet)
    - [Canary](https://aman.ai/primers/ai/speech-processing/#canary)
- [Suggested Videos](https://aman.ai/primers/ai/speech-processing/#suggested-videos)
- [References](https://aman.ai/primers/ai/speech-processing/#references)
- [Acknowledgements](https://aman.ai/primers/ai/speech-processing/#acknowledgements)
- [Citation](https://aman.ai/primers/ai/speech-processing/#citation)
...
![](https://aman.ai/primers/ai/assets/speech/Spectrum.jpg)
...
![](https://aman.ai/primers/ai/assets/speech/Spectrogram1.jpg)

- Rotate it by 90 degrees:

![](https://aman.ai/primers/ai/assets/speech/Spectrogram2.jpg)

- Color-code the amplitude:

![](https://aman.ai/primers/ai/assets/speech/Spectrogram3.jpg)
...
![](https://aman.ai/primers/ai/assets/speech/spec3.jpg)
...
![](https://aman.ai/primers/ai/assets/speech/mfcc.jpg)
...
![](https://aman.ai/primers/ai/assets/speech/Spectrograms-and-Oscillograms-This-is-an-oscillogram-and-spectrogram-of-the-boatwhistle.png)
...
![](https://aman.ai/primers/ai/assets/speech/siritechstack.jpg)
...
- The input audio (typically stored as a wave-file, but could be another audio format as well, such as FLACC, OGG, etc.) is converted to a feature sequence (f1,…,fT). The goal is to find a sequence of words (w1,…,wN) that matches the feature sequence best.
...
- The purpose of ASR is to map input waveform sequences to their corresponding word or character sequences. Therefore, implementing ASR can be considered a channel decoding or pattern classification problem. Statistical modeling is a core ASR method, in which, for a given speech waveform sequence O, we can use a “maximum a posteriori” (MAP) estimator, based on the mode of a posterior Bayesian distribution, to estimate the most likely output sequence W∗, with the formula shown in the figure below.
    ...
    ![](https://aman.ai/primers/ai/assets/speech/asr_math.png)
    
    - where, P(O∣W) is the probability of generating the correct observation sequence, i.e. corresponding to the acoustic model (AM) of the ASR system, conditional on W. Likelihood P(W) is the ‘a priori probability’ of the exact sequence W occurring. It is called the language model (LM).
...
![](https://aman.ai/primers/ai/assets/speech/asrsys.png)
...
![](https://aman.ai/primers/ai/assets/speech/gmmhmm_dnnhmm.png)
...
![](https://aman.ai/primers/ai/assets/speech/dnnhmm.jpg)
...
![](https://aman.ai/primers/ai/assets/speech/phone-word-sentence-hierarchy.png)
...
![](https://aman.ai/primers/ai/assets/speech/viterbi_trellis.png)
...
![](https://aman.ai/primers/ai/assets/speech/aon-kws.jpg)
...
![](https://aman.ai/images/papers/dvectors.jpg)
...
- In the section on [Precision-Recall (PR) Curves](https://aman.ai/primers/ai/speech-processing/#precision-recall-curve), we explore how to get the best out of these two metrics using PR curves.
...
- We saw [earlier](https://aman.ai/primers/ai/speech-processing/#precision-and-recall) that when a dataset has imbalanced classes, precision and recall are better metrics than accuracy. Similarly, for imbalanced classes, a Precision-Recall curve is more suitable than a ROC curve.
...
- Similar to the [AUROC](https://aman.ai/primers/ai/speech-processing/#area-under-the-roc-curve-auc), the PR AUC summarizes the curve with a range of threshold values as a single score.
...
|---|---|---|
|Accuracy|TP+TNTP+TN+FP+FN|Overall performance of model|
|Precision|TPTP+FP|How accurate the positive predictions are|
|Recall/Sensitivity|TPTP+FN|Coverage of actual positive sample|
|Specificity|TNTN+FP|Coverage of actual negative sample|
...
[![](https://aman.ai/primers/ai/assets/speech/asr_leaderboard.png)](https://huggingface.co/spaces/hf-audio/open_asr_leaderboard)
...
![](https://aman.ai/primers/ai/assets/speech/distil-whisper.jpeg)
...
- [Deep Learning in Speech Recognition by Alex Acero, Apple Inc.](https://www.youtube.com/watch?v=RBgfLvAOrss)
- [End-to-End Models for Speech Processing at Stanford by Navdeep Jaitly, NVIDIA](https://www.youtube.com/watch?v=3MjIkWxXigM)
- [Speech Recognition (ASR) by Andrew Senior, Google](https://www.youtube.com/watch?app=desktop&v=HyUtT_z-cms&feature=youtu.be)
- [Text to Speech (TTS) by Andrew Senior, Google](https://www.youtube.com/watch?v=1Mb-KHQNdcM)
- [Automatic Speech Recognition: An Overview by Preethi Jyothi, IIT Bombay](https://www.youtube.com/watch?v=q67z7PTGRi8)
- [Machine Learning and Causal Inference by Susan Athey, Stanford](https://www.youtube.com/watch?v=DixuYCsXFig&feature=emb_title)

## References

- [Speech Technology - Kishore Prahallad](http://www.speech.cs.cmu.edu/15-492/slides/03_mfcc.pdf)
- [Speech and Language Processing by Jurafsky and Martin, 2nd Edition, 2008](https://web.stanford.edu/~jurafsky/slp3/)
- [Interspeech 2017 Series Acoustic Model for Speech Recognition Technology](https://www.alibabacloud.com/blog/interspeech-2017-series--acoustic-model-for-speech-recognition-technology_436318)
- [What’s the difference between a phoneme, a phone, and an allophone?](https://linguisticsstudyguide.com/difference-between-phoneme-phone-allophone/)
- [Speaker Verification and Identification](https://slsp.kaist.ac.kr/paperdata/book_chapter.pdf)
- [Understanding automatic speech recognition (ASR)](https://judyboon.github.io/blog/speech/basics/2017/07/18/Understanding-ASR.html)
- [Gap between DNN and HMM](https://judyboon.github.io/blog/speech/basics/2017/07/15/the-bridge-between-DNN-HMM.html#fn:ref1)

## Acknowledgements

- Thanks to [Bharani Kempaiah](https://www.linkedin.com/in/bharani-ujjaini-kempaiah/) for helping proof-read this article and offering suggestions for improvement.
...
`@article{Chadha2020DistilledSpeechProcessing,   title   = {Speech Processing},   author  = {Chadha, Aman and Kempaiah, Bharani},   journal = {Distilled AI},   year    = {2020},   note    = {\url{https://aman.ai}} }`
