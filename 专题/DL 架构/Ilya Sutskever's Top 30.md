...
- **Architecture**:
    ...
    - The RN computes pairwise relations using a functiongθgθ and aggregates these relations using a functionfϕfϕ, allowing the network to infer and reason about the relationships between objects.
